...
public class Node {
    ...
    public ArrayList<ArrayList<Character>> best() {
        ...
        for (int i = 0; i < this.children.size(); i++) {
            if (this.children.get(i).won > this.children.get(i).lose &&
                    this.children.get(i).won - this.children.get(i).lose >
                            this.children.get(best).won - this.children.get(best).lose) {
                best = i;
            }
        }
